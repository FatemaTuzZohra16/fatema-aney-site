                    ...
                    <div className='flex flex-wrap justify-between gap-y-6 text-white mt-[90px]'>
                        {
                            projects.map((project) => (
                                <div className='w-[32%] border rounded-2xl overflow-hidden'>
                                    <img src={project.img} className='w-full h-[200px] object-cover object-top' />
                                    <div className='p-5'>
                                        <div>
                                            <h1 className='font-heading font-semibold text-primary text-[24px] leading-[40px] mt-[10px]'>{project.title}</h1>
