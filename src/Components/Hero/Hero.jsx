...
const Hero = () => {
  return (
    <div className='relative bg-black pb-[90px] pt-[150px] overflow-visible'>
      ...
      <Container className='relative'>
        <div className='lg:flex justify-between items-center'>
          <div className='w-auto md:w-[60%]'>
            ...
            <h1 className='text-white font-heading font-semibold text-[37px] md:text-[45px] leading-[55px] md:leading-[65px]'>Fatema Tuz Zohra</h1>
            ...
            <div className='flex gap-x-6'>
              <Link to='/about'>
                <button className='bg-primary text-white font-body py-3 px-[25px] rounded cursor-pointer hover:scale-110 transition-all duration-300 relative z-10'>About Me</button>
              </Link>
              <a href='/aney.pdf' download>
                <button className='bg-primary text-white font-body py-3 px-[25px] rounded cursor-pointer hover:scale-110 transition-all duration-300 relative z-10'>Download Resume</button>
              </a>
            </div>
          ...
          <div className='text-center mt-10 md:pl-[100px] lg:pl-0'>
