...
const Hero = () => {
  return (
    <div className='relative bg-black py-[90px] overflow-visible'>
      <Lottie
  ...
  />
      <Container>
        <div className='flex justify-between'>
          <div className='w-[60%]'>
            <h3 className='font-body text-[28px] leading-[40px] text-primary'>Hello, I'm</h3>
            <h1 className='text-white font-heading font-semibold text-[50px] leading-[65px]'>Fatema Tuz Zohra</h1>
            <h2 className='text-primary font-body font-medium text-[28px] leading-[40px] py-2'>Frontend Web Developer</h2>
            <p className='w-[641px] pt-5 pb-8 font-body text-white leading-[29px] text-[18px]'>Bringing ideas to life with code, I create interactive, seamless, and engaging web experiences that leave a lasting impression. Using HTML, CSS, React, and Tailwind, I focus on building websites that are not only visually appealing but also intuitive, responsive, and highly functional. My goal is to craft digital experiences that delight users, elevate brands, and turn ideas into reality.</p>
            <div className='flex gap-x-4'>
              <button className='bg-primary text-white font-body py-2 px-[25px] rounded'>About Me</button>
              <button className='bg-primary text-white font-body py-2 px-[25px] rounded'>Download Resume</button>
            </div>
            <h2 className='text-white font-heading font-semibold text-[50px] leading-[65px] mt-8'>Find Me On</h2>
